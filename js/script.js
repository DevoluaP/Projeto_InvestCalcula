...
// Input com Expressão Regular
// document.getElementById('initCon').toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
// document.getElementById('montCon').toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
...
function calculateCompoundInterest () {
    ...
    function updateResultValues(initCon, montCon, yldTime, intRate, totalInvest, totalCompInt, valTotal) {
...
document.querySelector('.newCalc').addEventListener('click', function () {
    ...
    document.querySelectorAll('#calculator input[type="number"]').forEach(function(input){input.value = null});
});
...
new Chart (pieChart, {
    ...
    data: {
        ...
        datasets: [{
            data: [300, 50, 100], // Esses valores vao ser as variaveis do resultado "Valor Inicial", "Valor em Juros" e "Valor total Investido"
            backgroundColor: [
                '#76ABAE',
                '#31363F',
                '#EEE'
